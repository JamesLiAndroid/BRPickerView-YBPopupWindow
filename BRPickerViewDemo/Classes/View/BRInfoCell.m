...
//    if ([rowItem isKindOfClass:[SZTextFieldBellItem class]]) {
//        self.isNext = YES;
//         self.textField.tapAcitonBlock = nil;
//        //self.textField.endEditBlock = [(SZTextFieldBellItem *)rowItem endEditingText];;
//    }
}
...
- (void) textFieldDidBeginEditing:(UITextField *)textField {
    if (_rowItem.startEditingText) {
        _rowItem.startEditingText(textField.text);
    }
}
...
//  NSLog(@"%ld---%@",textField.tag,textField.text);
    //替换元素
    if (_rowItem.endEditingText) {
        _rowItem.endEditingText(textField.text);
    }
